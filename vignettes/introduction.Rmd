...
(Note: **dataverse** is the next-generation iteration of [the **dvn** package](http://cran.r-project.org/package=dvn), which works with Dataverse 3 ("Dataverse Network") applications. See the appendix of this vignette for a cross-walk of functionality between **dvn** and **dataverse**.)
